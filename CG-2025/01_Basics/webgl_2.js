...
// Vertex Shader as a string -> Variable = a string que contiene el programa
// in (input) - tipo de dato en nuestro caso vector de 4 dimensiones - nombre variable usa a_ pot atributo
//El programa corre por cada vértice
//resultado es un output tipo vector - usa v_ por que es un varying...
//en el main avanza a la siguiente posicion
...
// Prepare the Vertex Shader program - crear shadders
...
// Compile the program with the shaders - juntar informacion en un programa
...
// in clip space
//Arreglo de coordenadas (x - y) - 32 bits cada elemento
//3 vertices
...
//Mandar posiciones - de que tamaño son los arreglos - tipo - normalizar - si debo avanzar o saltar
