...
function main_twgl() {
  ...
  //Estas 3 lineas deben ir por cada objeto
...
//Define la información del triangulo
  ...
  let arrays = {
    a_position: {
      ...
      data: new Float32Array([
        0.42, 0.7, 0.95, -0.7, 0.05, -0.7,

        -0.42, 0.7, -0.95, -0.7, 0, -0.7,

        -0.45, 0.7, -0.97, -0.7, 0, -0.7,
      ]),
    },
    a_color: {
      ...
      data: new Uint8Array([
        ...
        87, 53, 8, 255, 0, 225, 0, 54, 0, 0, 95, 255,
