...
import { shapeCircle, shapeF } from "../libs/shapes.js";
...
// Objeto llamado objects - guardadr info de transformaciones asociada al modelo
// Aqui es donde se definen las propiedades (caracteristicas) y se agregarían más
const objects = {
  model: {
    transforms: {
      t: {
...
function main() {
  ...
  //const arrays = shapeCircle(sides);
  const arrays = shapeF();
  ...
  // Se vueve a dibujar porque se esta modificando
